...
public class RequestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=view.findViewById(R.id.recycle_view_f_request);
    ...
    private void readUsers()
    {
        databaseReference.child("PROPOSES").child(firebaseUser.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                ...
                {
                    if(dataSnapshot.getValue(String.class).equals("REQUEST") || dataSnapshot.getValue(String.class).equals("NOTIFY"))
                    {
